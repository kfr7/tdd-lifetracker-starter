...
- [x] The activity tracked should be given a unique id for easy lookup.
  * [Table Schema](https://github.com/kfr7/tdd-lifetracker-starter/blob/main/lifetracker-api/lifetracker-schema.sql) 
...
To a certain degree, I feel that context was not covered in depth and we didn't get enough practice of it im order for us to rely so heavily on it. So that is why I had the bug where I had to refresh after loggin in or registering. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have made error handling better. As well as hopefully find out how to fix the refresh error.
...
Shout out to Stephane for coding with me even after hours to get certain parts done for this project.